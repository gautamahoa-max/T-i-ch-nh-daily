  ...
  return (
    <div ref={dockRef} className="relative w-full h-full pointer-events-none">
      ...
      <button
        ...
        className={`absolute right-0 bg-accent text-white w-10 h-14 md:w-12 md:h-16 rounded-l-full shadow-[-4px_4px_15px_rgba(33,184,136,0.3)] transition-all duration-300 flex items-center justify-center pl-1 hover:bg-accent/90 focus:outline-none z-10 opacity-50 hover:opacity-100 md:opacity-100 ${
      ...
      >
        ...
        <div className="mt-4 flex flex-col gap-5 items-center">
          ...
          <a
            ...
            className="w-9 h-9 md:w-11 md:h-11 rounded-full flex items-center justify-center hover:-translate-x-1 transition-transform duration-300 group relative"
          ...
          <a
            href="tel:0988886447"
            className="w-9 h-9 md:w-11 md:h-11 bg-accent rounded-full shadow-[0_4px_15px_rgba(33,184,136,0.4)] flex items-center justify-center hover:-translate-x-1 transition-transform duration-300 relative group"
