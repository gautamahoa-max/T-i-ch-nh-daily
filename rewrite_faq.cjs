...
export default function FAQSection() {
  ...
  const faqs = [
    {
      question: "Thẻ tín dụng là gì? Hạn mức thẻ tín dụng là gì?",
      answer: (
    ...
    {
      question: "Điều kiện mở thẻ tín dụng OCB?",
      answer: (
        <div className="text-gray-600 leading-relaxed space-y-2">
          <p>Khách hàng mở thẻ tín dụng OCB cần đáp ứng các điều kiện sau đây:</p>
          <ul className="list-disc pl-5 space-y-1">
            <li><span className="font-semibold text-black">Quốc tịch:</span> Người Việt Nam</li>
            <li><span className="font-semibold text-black">Địa chỉ cư trú/làm việc:</span> Tại các tỉnh/thành phố có Chi nhánh/Phòng giao dịch của OCB</li>
            <li><span className="font-semibold text-black">Độ tuổi:</span> Chủ thẻ chính từ đủ 20 tuổi đến 65 tuổi; Chủ thẻ phụ từ đủ 15 tuổi trở lên</li>
            <li><span className="font-semibold text-black">Các yêu cầu khác:</span> Theo quy định của OCB từng thời kỳ.</li>
          </ul>
        </div>
      )
    },
    {
      question: "Thẻ tín dụng có rút được tiền tại máy ATM không?",
      answer: (
    ...
    {
      question: "Tôi muốn nâng hạn mức Thẻ tín dụng thì phải làm sao?",
      answer: (
        <p className="text-gray-600 leading-relaxed">
    ...
    {
      question: "Số tiền thanh toán tối thiểu của Thẻ tín dụng được tính như thế nào?",
      answer: (
        <p className="text-gray-600 leading-relaxed">
    ...
    {
      question: "Lãi suất sẽ được tính như thế nào?",
      answer: (
        <div className="text-gray-600 leading-relaxed space-y-2">
          <p className="font-semibold text-black">Các giao dịch rút tiền mặt:</p>
          <p>
          ...
          <p className="font-semibold text-black mt-4">Các giao dịch trả góp:</p>
          <p>
          ...
          <p className="font-semibold text-black mt-4">Các giao dịch thanh toán tiền hàng hóa, dịch vụ:</p>
          <p>
    ...
    {
      question: "Tiền chuyển vào thẻ tín dụng sẽ có thứ tự thanh toán như thế nào?",
      answer: (
        <div className="text-gray-600 leading-relaxed space-y-2">
          ...
          <ul className="list-none pl-5 space-y-1">
            <li className="flex gap-2">
              <span className="text-[#006633]">•</span>
    ...
    {
      question: "Tôi có mất phí, lãi gì khi đăng ký trả góp hay không?",
      answer: (
        <p className="text-gray-600 leading-relaxed">
    ...
    {
      question: "Thời gian miễn lãi của các thẻ tín dụng như thế nào?",
      answer: (
        <div className="text-gray-600 leading-relaxed space-y-2">
    ...
    {
      question: "Nếu tôi thanh toán trễ so với thông báo của ngân hàng, tôi sẽ chịu các khoản phí/lãi gì?",
      answer: (
        <p className="text-gray-600 leading-relaxed">
    ...
    {
      question: "Tôi không kích hoạt thẻ thì có bị mất phí gì không?",
      answer: (
        <p className="text-gray-600 leading-relaxed">
  ...
  return (
    <section id="faq" className="w-full bg-[#FAFAFA] py-16 md:py-24 scroll-mt-20">
      <div className="container mx-auto px-6 md:px-12 max-w-[1000px]">
        
        <h2 className="text-3xl md:text-4xl font-bold text-black mb-10 text-left">
          Câu hỏi thường gặp
        </h2>
